...
public class GoodsSetDiscountView extends BaseView {
    private Context context;
    private View view;

    public GoodsSetDiscountView(Context context) {
        super(context);
    ...
    public View initGroupView() {
        view=View.inflate(context, R.layout.view_goods_set_discount,null);
