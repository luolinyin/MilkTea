...
public class ReturnGoodsLeftView extends BaseView {
    private Context context;
    private View view;

    public ReturnGoodsLeftView(Context context) {
        super(context);
    ...
    public View initGroupView() {
        view=View.inflate(context, R.layout.view_returngoods_left,null);
