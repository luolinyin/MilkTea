 ...
 */
public class SetLeftItemMenuView extends BaseView {
    private View view;
    private Context context;
    //设置监听回调
    private SetLeftItemMenuView leftItemMenuView;
    private OnLeftItemMenuListenner onLeftItemMenuListenner;


    private TextView setleft_item_menu;
    private String itemName;

    public SetLeftItemMenuView(Context context, String itemName, OnLeftItemMenuListenner onLeftItemMenuListenner) {
        super(context);
    ...
    public View initGroupView() {
        view = View.inflate(context, R.layout.view_set_left_item_menu, null);
    ...
    public void initView() {
        setleft_item_menu = (TextView) view.findViewById(R.id.setleft_item_menu);
    }

    @Override
    public void initData() {
        if (itemName == null) {
            setleft_item_menu.setText("");
        } else {
            setleft_item_menu.setText(itemName);
        }
