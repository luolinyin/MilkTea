...
public class MainReportFormView extends BaseView {
    private Context context;
    private View view;

    public MainReportFormView(Context context) {
        super(context);
    ...
    public View initGroupView() {
        view=View.inflate(context, R.layout.view_main_report_form,null);
