...
public class MainGoalAttainmentView extends BaseView {
    private Context context;
    private View view;

    public MainGoalAttainmentView(Context context) {
        super(context);
    ...
    public View initGroupView() {
        view=View.inflate(context, R.layout.view_main_goal_attainment,null);
